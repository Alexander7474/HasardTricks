...
<html lang="fr">
    ...
    <body class="body">
        ...
        <header>
            ...
            <!-- bar de recherche -->
            <br />
        <input type="text" id="findField" value="..." size="20" />  <!-- id = findField permer de recuperer le texte dans une variable en string-->
        <button onclick="FindNext ();">Reachercher</button>
            <!-- navigation -->
        <nav class="Out">
            <ul>
            <li class="btn">
                <a href="out-street.php" target="_BLANK">
                Tricks pour O.u.t Street
                </a>
            </li>
            <li class="btn">
                <a href="out-park.php" target="_BLANK">
                Tricks pour O.u.t Park
                </a>
            </li>
            <li class="btn">
                <a href="typeTricks.php" target="_BLANK">
                Type de Tricks
                </a>
            </li>
            <li class="btn">
                <a href="Spot_map.php" target="_BLANK">
                Spot map
                </a>
            </li>
            </ul>
